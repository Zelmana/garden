...
aliases:
  - home
---
![[Cornelis Decker - A Cottage among Trees on the Bank of a Stream.jpg]]

---

# Who's Zelmana?

I'm Zelmana. Most people just call me Zelm. This is my personal archive uploaded in the format of a digital garden. The last blurb on this page explains what that is.

For work I do a lot of cybersecurity vulnerability analysis and threat intelligence. For fun, I like to collect hobbies and learn different skills. Hobby collecting is a hobby!

As such, this garden will have a breadth of topics, but in some seasons may focus on one or two specific domains of interest. I will try to update this homepage to reflect that every now and then. Some random interests of mine below, in no particular order.

- Cybersecurity / Vulnerability Analysis
- Open Source Software & Information Access
- Theology
- Game Development in Unreal Engine (From a Non-programmer perspective)
- Roleplay Engine Architecture
- Leathercraft
- Art
...
| Stage       | Purpose                                                               |
| ----------- | --------------------------------------------------------------------- |
| **Seed**    | Random spurs of writing, half-thoughts, initial topic spitballing     |
